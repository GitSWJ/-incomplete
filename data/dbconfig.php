...
define('G5_MYSQL_HOST', 'localhost:3308');
define('G5_MYSQL_USER', 'root');
define('G5_MYSQL_PASSWORD', 'root');
define('G5_MYSQL_DB', 't_pass');
define('G5_MYSQL_SET_MODE', false);

define('G5_TABLE_PREFIX', 't_pass');

define('G5_TOKEN_ENCRYPTION_KEY', '6505a6e9e088f592c523a813888c3710'); // 토큰 암호화에 사용할 키
...
define('G5_SHOP_TABLE_PREFIX', 't_pass_shop_');
