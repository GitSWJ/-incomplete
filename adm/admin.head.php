    ...
    <div id="hd_top">
        ...
        <div id="tnb">
            <ul>
                ...
                <li class="tnb_li"><a href="<?php echo G5_ADMIN_URL ?>/product.php" class="tnb_service">제품관리</a></li>
                <li class="tnb_li"><a href="<?php echo G5_ADMIN_URL ?>/adm_order_list.php" class="tnb_service">상담관리</a></li>
